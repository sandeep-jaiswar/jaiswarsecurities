/*
  ...
  1. Sample Data
    - Insert 20 major stock symbols with metadata
    - Generate 30 days of OHLCV data for AAPL
    - Generate corresponding technical indicators
    - Create sample watchlists and alerts
...
SELECT 
    ...
    (50 + RANDOM() * 50)::numeric(8,4) as score,
    '{"rsi_check": true, "volume_check": true}'::jsonb as criteria_met,
    json_build_object(
        'close_price', (150 + RANDOM() * 50)::numeric(12,4),
        'volume', (1000000 + RANDOM() * 5000000)::bigint,
        'rsi', (30 + RANDOM() * 40)::numeric(8,4)
